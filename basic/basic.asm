...
*   REVISED 08-MAY-17 TO WORK WITH THE RC2017/04 HD6309 COMPUTER BY N.A. MOSELEY
*
EOL EQU $04
ETX EQU $03
SPACE   EQU $20
...
LORAM   EQU $0000   ADDRESS OF DIRECT PAGE SCRATCH RAM
BUFFER  EQU $0100   ADDRESS OF MAIN RAM
RAMSIZ  EQU $7E00   SIZE OF MAIN RAM
ROMADR  EQU $8000   ADDRESS OF TINY BASIC ROM/RAM LOCATION
*
...
INEEE   BSR BRKEEE
    BEQ INEEE
    LDA SER_RX              * NAM: updated
    ANDA    #$7F
    RTS
OUTEEE  PSHS    A
OUT01 LDA SER_LSR           * NAM: updated
    BITA #32                * NAM: updated
    BEQ OUT01
    PULS    A
    STA SER_TX              * NAM: updated
    RTS

* BRK clears the 6850 overrun condition, if necessary    
* and sets the zero flag to '1' if there is a
* character in the UART receive buffer
...
* FIXME: WHAT IS THIS?!?! left over code?
*
*    LDA #CNTL1
*    STA RMCR
*    LDA #CNTL2
